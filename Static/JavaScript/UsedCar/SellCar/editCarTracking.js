var editCarTracking = (function () {
    ...
    var gaTrackingCategoryDesktop = "DesktopEditCar";
    var eventType = {
    ...
    function trackForMobile(action, label) {
        switch (action) {
            ...
            case actionType.imageSave:
                ...
                break;
            case actionType.spamComment:
                    Common.utils.trackAction(eventType.cwInteractive, gaTrackingCategoryDesktop, actionType.spamComment, label);
                    break;
            case actionType.commentsAdded:
                    Common.utils.trackAction(eventType.cwInteractive, gaTrackingCategoryDesktop, actionType.commentsAdded, label);
                    break;
            default:
        }
    }

    function trackForDesktop(action, label) {
        switch (action) {
            case actionType.spamComment:
                    Common.utils.trackAction(eventType.cwInteractive, gaTrackingCategoryDesktop, actionType.spamComment, label);
                    break;
    ...
    return {
        ...
        trackForDesktop: trackForDesktop,
